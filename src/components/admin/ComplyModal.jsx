          ...
          <TEModalContent>
            ...
            <TEModalBody>
              <>
                ...
                <div className="p-2 mb-3 bg-slate-100 rounded-md">
                  <h6 className="font-semibold text-red-600">Remainder!</h6>
                  <p>
                    Make sure to throughly check the details of the applicant
                    before you commit.
                  </p>
                </div>
                ...
                {isApproved && (
                  <div className="py-2">
                    <fieldset className="flex max-w-md flex-col gap-4">
                      <legend className="mb-4">7.C Approved For:</legend>
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="radio1">Days with pay.</Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Radio
                          id="radio2"
                          ...
                          onChange={(e) => setPayType(e.target.value)}
                        />
                        <Label htmlFor="radio2">Days without pay.</Label>
                      </div>
                    </fieldset>
